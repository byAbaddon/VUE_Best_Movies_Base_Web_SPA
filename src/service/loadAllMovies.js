...
const loadAllMoviesFromBase = (options = {}, callback, errorCallback) => {
  const ref = collection(db, "privateMovies")
  ...
  if (options.filter) {
    for (const [field, value] of Object.entries(options.filter)) {
      if (field === "genre") {
        ...
        q = query(q, where(field, "array-contains-any", genres))
      } else {
...
export { loadAllMoviesFromBase, stopMoviesListener }
